...
module.exports = function uninstall(){
	...
	return gladys.utils.sql('DELETE FROM sentence WHERE uuid in (?,?,?,?)', [sentences.sentenceShutdownEn.uuid, sentences.sentenceRebootEn.uuid, sentences.sentenceShutdownFr.uuid, sentences.sentenceRebootFr.uuid]);
